...
class GetFriendListsRespense;
class GetFriendListsRespenseDefaultTypeInternal;
extern GetFriendListsRespenseDefaultTypeInternal _GetFriendListsRespense_default_instance_;
class LoginRequest;
...
template<> ::fixbug::GetFriendListsRespense* Arena::CreateMaybeMessage<::fixbug::GetFriendListsRespense>(Arena*);
...
class GetFriendListsRespense :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListsRespense) */ {
 public:
  GetFriendListsRespense();
  virtual ~GetFriendListsRespense();

  GetFriendListsRespense(const GetFriendListsRespense& from);
  GetFriendListsRespense(GetFriendListsRespense&& from) noexcept
    : GetFriendListsRespense() {
    *this = ::std::move(from);
  }

  inline GetFriendListsRespense& operator=(const GetFriendListsRespense& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListsRespense& operator=(GetFriendListsRespense&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriendListsRespense& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriendListsRespense* internal_default_instance() {
    return reinterpret_cast<const GetFriendListsRespense*>(
               &_GetFriendListsRespense_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(GetFriendListsRespense& a, GetFriendListsRespense& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListsRespense* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GetFriendListsRespense* New() const final {
    return CreateMaybeMessage<GetFriendListsRespense>(nullptr);
  }

  GetFriendListsRespense* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriendListsRespense>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriendListsRespense& from);
  void MergeFrom(const GetFriendListsRespense& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListsRespense* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListsRespense";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListsRespense)
 private:
  class _Internal;
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendListsRespense::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFriendListsRespense::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListsRespense::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListsRespense::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendListsRespense::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsRespense.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* GetFriendListsRespense::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsRespense.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListsRespense::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendListsRespense::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsRespense.result)
  return _internal_mutable_result();
}
inline void GetFriendListsRespense::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsRespense.result)
}

// repeated .fixbug.User friend_list = 2;
inline int GetFriendListsRespense::_internal_friend_list_size() const {
  return friend_list_.size();
}
inline int GetFriendListsRespense::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GetFriendListsRespense::clear_friend_list() {
  friend_list_.Clear();
}
inline ::fixbug::User* GetFriendListsRespense::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsRespense.friend_list)
  return friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListsRespense::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsRespense.friend_list)
  return &friend_list_;
}
inline const ::fixbug::User& GetFriendListsRespense::_internal_friend_list(int index) const {
  return friend_list_.Get(index);
}
inline const ::fixbug::User& GetFriendListsRespense::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsRespense.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* GetFriendListsRespense::_internal_add_friend_list() {
  return friend_list_.Add();
}
inline ::fixbug::User* GetFriendListsRespense::add_friend_list() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsRespense.friend_list)
  return _internal_add_friend_list();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListsRespense::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsRespense.friend_list)
  return friend_list_;
}
