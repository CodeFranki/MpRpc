...
class GetFriendListsRespenseDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendListsRespense> _instance;
} _GetFriendListsRespense_default_instance_;
}  // namespace fixbug
...
static void InitDefaultsscc_info_GetFriendListsRespense_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendListsRespense_default_instance_;
    new (ptr) ::fixbug::GetFriendListsRespense();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendListsRespense::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendListsRespense_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendListsRespense_test_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsRespense, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsRespense, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListsRespense, friend_list_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::fixbug::ResultCode)},
  { 7, -1, sizeof(::fixbug::User)},
  { 15, -1, sizeof(::fixbug::LoginRequest)},
  { 22, -1, sizeof(::fixbug::LoginResponse)},
  { 29, -1, sizeof(::fixbug::GetFriendListsRequest)},
  { 35, -1, sizeof(::fixbug::GetFriendListsRespense)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendListsRespense_default_instance_),
};
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "enseB\003\200\001\001b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test_2eproto_sccs[6] = {
  ...
  &scc_info_GetFriendListsRespense_test_2eproto.base,
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(_internal_mutable_errmsg(), ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(_internal_mutable_pwd(), ptr, ctx);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListsRequest::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
void GetFriendListsRespense::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListsRespense_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFriendListsRespense::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendListsRespense* msg);
};

const ::fixbug::ResultCode&
GetFriendListsRespense::_Internal::result(const GetFriendListsRespense* msg) {
  return *msg->result_;
}
GetFriendListsRespense::GetFriendListsRespense()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:fixbug.GetFriendListsRespense)
}
GetFriendListsRespense::GetFriendListsRespense(const GetFriendListsRespense& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.GetFriendListsRespense)
}

void GetFriendListsRespense::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListsRespense_test_2eproto.base);
  result_ = nullptr;
}

GetFriendListsRespense::~GetFriendListsRespense() {
  // @@protoc_insertion_point(destructor:fixbug.GetFriendListsRespense)
  SharedDtor();
}

void GetFriendListsRespense::SharedDtor() {
  if (this != internal_default_instance()) delete result_;
}

void GetFriendListsRespense::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendListsRespense& GetFriendListsRespense::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListsRespense_test_2eproto.base);
  return *internal_default_instance();
}


void GetFriendListsRespense::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.GetFriendListsRespense)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* GetFriendListsRespense::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListsRespense::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.GetFriendListsRespense)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(2, this->_internal_friend_list(i), target, stream);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.GetFriendListsRespense)
  return target;
}

size_t GetFriendListsRespense::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListsRespense)
  size_t total_size = 0;
...
void GetFriendListsRespense::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendListsRespense)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListsRespense* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListsRespense>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendListsRespense)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendListsRespense)
    MergeFrom(*source);
  }
}

void GetFriendListsRespense::MergeFrom(const GetFriendListsRespense& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListsRespense)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void GetFriendListsRespense::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendListsRespense)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void GetFriendListsRespense::CopyFrom(const GetFriendListsRespense& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.GetFriendListsRespense)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool GetFriendListsRespense::IsInitialized() const {
  return true;
}

void GetFriendListsRespense::InternalSwap(GetFriendListsRespense* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendListsRespense::GetMetadata() const {
  return GetMetadataStatic();
}
    ...
    case 1:
      GetFriendList(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendListsRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFriendListsRespense*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    ...
    case 1:
      return ::fixbug::GetFriendListsRespense::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
void UserServiceRpc_Stub::GetFriendList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                              ...
                              ::fixbug::GetFriendListsRespense* response,
                              ::google::protobuf::Closure* done) {
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListsRespense* Arena::CreateMaybeMessage< ::fixbug::GetFriendListsRespense >(Arena* arena) {
  return Arena::CreateInternal< ::fixbug::GetFriendListsRespense >(arena);
}
